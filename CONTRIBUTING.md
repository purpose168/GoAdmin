...
See [manual](https://github.com/purpose168/GoAdmin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/purpose168/GoAdmin clone, so:
...
Notice: `go get` return `package github.com/purpose168/GoAdmin: no Go files in /go/src/github.com/purpose168/GoAdmin` is normal.
...
* [Tasks](https://github.com/purpose168/GoAdmin/projects)
