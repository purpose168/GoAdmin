// beego.go - Beego2 框架适配器文件
// 包名：beego
// 作者：GoAdmin 团队
// 创建日期：2020年
// 描述：本文件提供 GoAdmin 在 Beego2 Web 框架下的适配器实现
...
import (
	...
	// 导入 Beego2 适配器，用于将 GoAdmin 集成到 Beego2 框架
	...
	"github.com/beego/beego/v2/server/web"                      // Beego2 Web 服务器包，提供 HTTP 服务器和路由功能
...
//
// 技术细节：
//   - 使用 web.NewHttpSever() 创建 Beego2 服务器实例
...
func internalHandler() http.Handler {
	// 创建 Beego2 HTTP 服务器实例
	app := web.NewHttpSever() // 创建 Beego2 服务器实例
	...
	// 配置监听地址
	app.Cfg.Listen.HTTPAddr = "127.0.0.1" // 设置监听地址为本地回环地址

	// 配置监听端口
	app.Cfg.Listen.HTTPPort = 9087 // 设置监听端口为 9087

	// 返回 Beego2 服务器的处理器
	return app.Handlers // 返回处理器
}
